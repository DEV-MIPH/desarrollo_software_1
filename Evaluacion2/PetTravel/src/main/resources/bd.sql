...
ALTER USER C##VIAJE_MASCOTA QUOTA UNLIMITED ON USERS;
...
GRANT ALL PRIVILEGES ON C##CONCURSO_MASCOTA.viaje TO C##VIAJE_MASCOTA;
GRANT ALL PRIVILEGES ON C##CONCURSO_MASCOTA.conductor_transporte_mascota TO C##VIAJE_MASCOTA;
